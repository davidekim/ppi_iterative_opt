...
parser.add_argument('--disulfidize', action='store_true', help='Include disulfide designs.')
parser.add_argument('--cleanup', action='store_true', help='Cleanup PDBs to save disk space.')
parser.add_argument('--verbose', action='store_true', help='Chatty output.')
parser.add_argument('--force', action='store_true', help='Ignore checkpoints and force running from the beginning.')
