...
def generate_masks(msa, task, loader_params, chosen_dataset, full_chain=None, xyz=None, cysteines=None): #full_chain is for complexes, to signify which chain is complete
    '''
    ...
    # dj - only perform diffusion hal on pdb and fb for now 
        ...
        if cysteines is not None:
            input_seq_mask[cysteines]=True #unmask cysteines
