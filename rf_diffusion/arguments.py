...
def get_args(in_args=None):
    ...
    loss_group.add_argument('-p_clamp',type=float, default=0.9,
            help = 'What proportion of examples do you want to clamp the loss on? Default is 90%')
    ...
    preprocess_group.add_argument('-provide_ss', action='store_true', default=False,
            help='Provide SS & block adjacency?')
    preprocess_group.add_argument('-provide_disulphides', action='store_true',default=False,
            help='Do you want to provide disulphide inputs?')
